...
public partial struct VelocitySystem : ISystem {
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        using (var predators = predatorQuery.ToEntityArray(Allocator.TempJob))
        {
            ...
            MoveJob movePreyJob = new MoveJob {
            ...
            MoveJob movePredatorJob = new MoveJob {
            ...
            var jobHandlePreyMovement = movePreyJob.Schedule(preys.Length, 128);
            var jobHandlePredatorMovement = movePredatorJob.Schedule(predators.Length, 128);
            JobHandle.CombineDependencies(jobHandlePreyMovement, jobHandlePredatorMovement).Complete();
